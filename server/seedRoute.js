...
const products = [
  {
    ...
    price: 68,
    category: "Tops",
    images: [{ url: "/linen-relaxed-shirt.jpg", alt: "Linen Shirt" }],
    sizes: ["XS", "S", "M", "L", "XL"],
    colors: ["White", "Sand"],
    stock: 45,
    isFeatured: true,
  ...
  },
  {
    ...
    price: 89,
    category: "Bottoms",
    images: [{ url: "/wide-leg-trousers.jpg", alt: "Trousers" }],
    sizes: ["XS", "S", "M", "L", "XL"],
    colors: ["Black", "Camel"],
    stock: 30,
    isFeatured: true,
  ...
  },
  {
    ...
    price: 120,
    category: "Tops",
    images: [{ url: "/merino-crew-knit.jpg", alt: "Knit" }],
    sizes: ["S", "M", "L", "XL"],
    colors: ["Oatmeal", "Navy"],
    stock: 20,
    isFeatured: true,
  ...
  },
  {
    ...
    comparePrice: 260,
    category: "Outerwear",
    images: [{ url: "/oversized-blazer.jpg", alt: "Blazer" }],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    price: 72,
    category: "Bottoms",
    images: [{ url: "/satin-slip-skirt.jpg", alt: "Skirt" }],
    sizes: ["XS", "S", "M", "L"],
  ...
  },
  {
    ...
    images: [{ url: "/tote-bag.jpg", alt: "Tote" }],
    sizes: ["One Size"],
  ...
  },
  {
    ...
    price: 115,
    category: "Outerwear",
    images: [{ url: "/puffer-vest.jpg", alt: "Vest" }],
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black", "Cream"],
    stock: 18,
    isFeatured: false,
  ...
  },
  {
    ...
    price: 32,
    category: "Tops",
    images: [{ url: "/ribbed-tank-top.jpg", alt: "Tank" }],
    sizes: ["XS", "S", "M", "L", "XL"],
...
module.exports = async (req, res) => {
  try {
    ...
    res.json({
      ...
      admin: "admin@velour.com / admin123",
      testUser: "jane@example.com / test123",
    });
  } catch (err) {
